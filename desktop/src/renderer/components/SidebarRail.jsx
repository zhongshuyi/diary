import { CalendarDays, FileImage, GitCompareArrows, List, PenLine, Plus, Settings, Sparkles, Tags, Trash2 } from 'lucide-react';
...
export function SidebarRail({ view, onView, onNew, syncKind, syncLabel }) {
  return <aside className="sidebar">
    <button type="button" className="new-entry-button" onClick={onNew}><Plus size={18} strokeWidth={2.2} /><span>新日记</span></button>
